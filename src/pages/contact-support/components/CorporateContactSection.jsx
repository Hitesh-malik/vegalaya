  ...
  const corporateContacts = [
    {
      ...
      manager: "Amit Verma",
      email: "partnerships@vegalaya.com",
      phone: "+91 11 4567 8901",
      description:
        "Restaurant partnerships, bulk orders, and food service solutions",
      icon: "Handshake",
    ...
    },
    {
      ...
      email: "quality@vegalaya.com",
      phone: "+91 11 4567 8902",
      description:
        "Product feedback, quality concerns, and improvement suggestions",
      icon: "Shield",
    ...
    },
    {
      ...
      email: "export@vegalaya.com",
      phone: "+91 11 4567 8903",
      description:
        "International distribution, export inquiries, and global partnerships",
      icon: "Globe",
    ...
    },
    {
      ...
      email: "media@vegalaya.com",
      phone: "+91 11 4567 8904",
      description:
        "Press inquiries, media partnerships, and brand collaborations",
      icon: "Megaphone",
      ...
      <div className="flex items-center space-x-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-text-secondary">
            Dedicated support for business inquiries and partnerships
          </p>
        </div>
      </div>
