...
const ProductDetailPage = () => {
  ...
  const mockProducts = {
    1: {
      ...
      galleryImages: [
        "/assets/images/vegacocolassi.jpg",
        "/assets/images/vegakesarchai.jpg",
        "/assets/images/vegamoka.jpg",
      ],
      rating: 4.5,
      reviewCount: 1247,
      discount: 15,
      ...
      spiceLevel: 1,
      textureDescription:
        "Ultra-smooth and creamy texture that spreads effortlessly without tearing bread. Perfect consistency for both spreading and mixing.",
      usageIdeas: [
      ...
      ingredients:
        "Refined Soybean Oil, Water, Egg Yolk, Sugar, Salt, Acetic Acid, Mustard Extract, Natural Flavors, Preservatives (Potassium Sorbate, Sodium Benzoate)",
    },
  };
